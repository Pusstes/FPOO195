...
complejidad_caracteres = 3  # Puedes ajustar este valor según la complejidad de los caracteres

fortaleza = contase.comprobarFortaleza(nueva_contrasena, caracteres_permitidos, complejidad_caracteres)
